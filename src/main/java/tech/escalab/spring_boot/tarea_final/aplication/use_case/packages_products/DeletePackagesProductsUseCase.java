package tech.escalab.spring_boot.tarea_final.aplication.use_case.packages_products;

import lombok.AllArgsConstructor;
import org.springframework.stereotype.Component;
import tech.escalab.spring_boot.tarea_final.domain.exception.base.DomainExceptionCode;
import tech.escalab.spring_boot.tarea_final.domain.exception.general.StatusInvalidException;
...
public class DeletePackagesProductsUseCase {
    ...
    public void execute(UUID uuid) throws StatusInvalidException {
        ...
        if(producto.getPackages() != null && !Status.LOADED.equals(producto.getPackages().getStatus()) ) {
            throw new StatusInvalidException(DomainExceptionCode.PACKAGES_STATUS_LOADED_INVALID);
        }
